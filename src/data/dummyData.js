export const sliderData = [
  ...
  },
  {
    id: 2,
    image:
      'https://res.cloudinary.com/rendezvouscare/image/upload/v1727131437/therapist_pm4xrh.jpg',
    title: 'Therapy on Your Terms',
    description:
      'Find your perfect therapist match and enjoy convenient, confidential online sessions with licensed professionals, anytime, anywhere.',
  },
  {
    id: 3,
    image:
      'https://res.cloudinary.com/rendezvouscare/image/upload/v1727131424/life-coach1_xso43a.png',
    title: 'Design the Life You Want',
    description:
      'Achieve your personal and professional goals with the help of a vetted, qualified, and dedicated coach.',
  },
  {
    id: 4,
    image:
...
export const sliderData2 = [
  {
    id: 1,
    image:
      'https://res.cloudinary.com/rendezvouscare/image/upload/v1741884431/image_574-2_ddki9y.png',
    title: 'Let only the Bests Guide you',
    description:
      'Invest in yourself and thrive with expert-guided therapy and life coaching.',
  },
  {
    id: 2,
    image:
      'https://res.cloudinary.com/rendezvouscare/image/upload/v1727131424/life-coach1_xso43a.png',
    title: 'Premium Experiences, seamless Travels',
    description:
      'Find trusted tour guides, luxury hotels, or rent a sleek car, effortlessly.',
  },
  {
    id: 3,
    image:
      'https://res.cloudinary.com/rendezvouscare/image/upload/v1727131434/store_y9y927.jpg',
    title: 'Shop Perfect Gifts for Every Occasion',
    description:
      'Shop thoughtful gifts that define sophistication for yourself or a loved one.',
  },
];

export const rendezvousWebsiteURL = 'https://rendezvouscare.com';
...
export const subscriptionPlans = [
  {
    ...
    subFeatures: [
      ...
      'Access to store',
      'Unlimited messaging',
      'Access to Therapists and Life Coaches',
      'Up to 6 media uploads',
    ],
  },
  {
    id: 2,
    ...
    subFeatures: [
      'Everything in Basic',
      '40 swipes daily',
      'Authorization to edit more profile information',
      'Access to red receipts',
      'Up to 10 media uploads',
      'Access to Vendor Platform',
  ...
  },
  {
    ...
    price: '$59.59',
    oldPrice: '$99.99',
    subType: 'Premium Plan',
    subFeatures: [
      'Everything in Ultimate',
      'Unlimited Swiping',
      'Advanced matching algorithms',
      'Authorization to edit more profile information',
      'Therapist and Life Coaches are recommended based on your preferences',
      'Notification for discounted products',
      'Up to 20 media uploads',
    ],
  },
];
...
export const carRentalSteps = [
  ...
  {
    title: 'Preferences',
    navigation: 'CelebOnboardingScreen',
  },
  {
    title: 'Confirmation',
    navigation: 'CelebProfilePicture',
  },
];
...
export const rendezvousGenders = [
  {value: 'i identify as a man', label: 'I identify as a man'},
  {value: 'i identify as a woman', label: 'I identify as a woman'},
  {value: 'i am not gender specific', label: 'I am not gender specific'},
  {value: 'i choose not to specify', label: 'I choose not to specify'},
];

export const rendezvousPersonalities = [
  {value: 'i am an introvert', label: 'I am an introvert'},
  {value: 'i am an extrovert', label: 'I am an extrovert'},
  {value: 'i am an ambivert', label: 'I am an ambivert'},
];

export const rendezvousRelationshipStatus = [
  {value: 'here to date', label: 'Here to date'},
  {value: 'open to chat', label: 'Open to chat'},
  {value: 'ready for a relationship', label: 'Ready for a relationship'},
];

export const rendezvousRelationshipStatus2 = [
...
export const rendezvousInterestedInOptions = [
  {value: 'looking for men', label: 'Looking for men'},
  {value: 'looking for women', label: 'Looking for women'},
];

export const rendezvousDrinkingOptions = [
...
export const rendezvousSmokingOptions = [
  {value: 'never', label: 'Never'},
  {value: 'occasionally', label: 'Occasionally'},
  {value: 'regularly', label: 'Regularly'},
  {value: 'often', label: 'Often'},
...
export const rendezvousHeightOptions = [
  {value: 'not so tall', label: 'Not so Tall'},
  {value: 'average height', label: 'Average'},
  {value: 'tall', label: 'Tall'},
  {value: 'very tall', label: 'Very Tall'},
];

export const rendezvousKidsOptions = [
  {value: 'yes- they live with me', label: 'Yes - They live with me'},
  {
    value: 'yes- they dont live with me ',
    label: "Yes - They don't live with me",
  },
  {value: 'no', label: 'No'},
];

export const therapyQuestionsOptions = [
  {
    label: 'I am totally new to this',
    value: 'new',
  },
  {
    label: 'I have been in the past',
    value: 'regularly',
  },
  {
    label: 'I occasionally see one',
    value: 'occasionally',
  },
];

export const therapyQuestionsOptions2 = [
  {
    label: 'Video Calls',
    value: 'Video-Calls',
  },
  ...
  {
    label: 'Text-based Conversations',
    value: 'Text-Based',
  },
];
...
export const therapyQuestionOption4 = [
  {
    value: 'Under $50',
    label: 'Under $50',
  },
...
export const therapyQuestionOption5 = [
  {
    value: 'Under 5years',
    label: 'Under 5years',
  },
...
export const rendezvousInterests = [
  'History',
  'Astronomy',
  'Film Analysis',
  'Architecture',
...
export const rendezvousHobbies = [
  'Painting',
  'Drawing/Sketching',
  'Sculpting',
  'Woodworking',
...
export const rendezvousQualification = [
...
export const validCounselingTypes = [
...
export const therapyPlatforms = ['Video-Calls', 'Phone-Calls', 'Text-Based'];

export const therapySkills = [
...
export const availableTimesForAppointmentDaily = [
  '01:00',
  '02:00',
  '03:00',
  '04:00',
...
export const validLifeCoachTypes = [
...
export const universitiesJson = [
  ...
  'Prescott College',
  'Prescott College, Center for Indian Bilingual Teacher Education',
